 ...
 *
 */
const idUrl     = 'module-queue-call-back';
const idForm    = 'module-queue-call-back-form';
const className = 'ModuleQueueCallBack';
const inputClassName = 'mikopbx-module-input';

/* global globalRootUrl, globalTranslate, Form, Config */
const ModuleQueueCallBack = {
	$formObj: $('#'+idForm),
		...
		switch (status) {
			...
			case 'Updating':
				window[className].$moduleStatus
					...
					.removeClass('red')
					.addClass('grey');
				window[className].$moduleStatus.html(`<i class="spinner loading icon"></i>${globalTranslate.module_queue_call_backUpdateStatus}`);
				break;
			default:
				window[className].$moduleStatus
					.removeClass('green')
